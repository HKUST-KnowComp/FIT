...
class ExtendedAppFOQEstimator(ABC, nn.Module):
    @abstractmethod
    def get_entity_embedding(self, entity_ids: torch.Tensor):
        pass

    def get_whole_embedding(self, batch_size):
        pass
    ...
    @abstractmethod
    def relation_conjunction(self, conj_rel_emb: List[torch.Tensor]):
        pass

    @abstractmethod
    def relation_negation(self, rel_emb):
        pass

    @abstractmethod
    def get_projection_embedding_extended(self, rel_emb: torch.Tensor, ent_emb):
        pass
