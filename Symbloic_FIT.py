...
def find_leaf_node(sub_graph: KnowledgeGraph, neg_sub_graph: KnowledgeGraph, now_candidate, now_variable):
    """
    Find a leaf node with least possible candidate. Always use constant entity first.
    """
    ...
    return return_candidate[0], return_candidate[1], now_variable == return_candidate[0]
